        ...
        <div className="flex flex-col gap-6 w-full max-w-full pb-32">
            ...
            <div className="bg-white rounded-3xl border border-slate-200 shadow-sm overflow-hidden flex flex-col xl:flex-row">
                <div className="p-6 xl:w-1/3 bg-slate-50 border-b xl:border-b-0 xl:border-r border-slate-200 flex flex-col justify-center">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex justify-between items-center bg-white px-5 py-3 rounded-xl border border-slate-100 shadow-sm">
                            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Berangkat</span>
                            <span className="text-sm font-black text-[#1d2d6a]">BD 19:00</span>
                        </div>
                        <div className="flex justify-between items-center bg-white px-5 py-3 rounded-xl border border-slate-100 shadow-sm">
                            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Status</span>
                            <span className="text-sm font-black text-blue-600">Menuju KTD</span>
                        </div>
                        <div className="flex justify-between items-center bg-white px-5 py-3 rounded-xl border border-slate-100 shadow-sm">
                            <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Tiba</span>
                            <span className="text-sm font-black text-[#1d2d6a]">SGU 07:31</span>
                        </div>
                    </div>
                </div>
            ...
            <div className="fixed bottom-0 left-0 lg:left-72 right-0 z-[60] bg-white/95 backdrop-blur-xl border-t border-slate-200 shadow-[0_-15px_40px_rgba(0,0,0,0.04)] px-6 py-4 lg:px-10 flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <div className="flex flex-wrap items-center justify-center gap-3 w-full md:w-auto">
                    ...
                    <button className="flex items-center justify-center gap-2 px-8 py-3 rounded-xl bg-[#1d2d6a] hover:bg-[#152355] text-xs font-black uppercase tracking-widest text-white transition-all shadow-lg hover:shadow-xl focus:outline-none focus:ring-2 focus:ring-blue-500/50 active:scale-95 w-full md:w-auto">
