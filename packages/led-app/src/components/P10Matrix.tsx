...
export const P10Matrix = ({ text, color = '#ff0000', speed = 50 }: P10MatrixProps) => {
    ...
    useEffect(() => {
        ...
        const render = (time: number) => {
            // Delta time control for speed
            // Speed prop is "interval in ms".
            // If speed is 60ms, we update position every 60ms?
            // Or we stick to requestAnimationFrame and move proportionally?
            // The previous implementation used setTimeout loop.
            // Let's use clean delta-time here for smoothness.
            ...
            if (time - lastUpdateRef.current > speedRef.current) {
                ...
                // Check for Loop End
                // The text width in logic is fullTextWidthRef
                // effectively the "text part" is fullTextWidthRef - LED_WIDTH (since we added buffer)
