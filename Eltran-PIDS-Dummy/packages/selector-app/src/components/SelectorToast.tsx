  ...
  return (
    <AnimatePresence>
      <motion.div
        ...
        className="fixed bottom-10 right-10 z-[70] bg-white dark:bg-slate-900 rounded-2xl shadow-[0_15px_50px_-10px_rgba(0,0,0,0.3)] overflow-hidden border border-slate-200 dark:border-slate-800 min-w-[350px] max-w-[420px] transition-all"
      >
