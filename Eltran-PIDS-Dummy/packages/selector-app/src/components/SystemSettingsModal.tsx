    ...
    <AnimatePresence>
      ...
      >
        <motion.div
          ...
          className="bg-[#f4f7f9] w-full h-full flex flex-col overflow-hidden"
        >
          <div className="bg-[#1d2d6a] px-8 py-5 text-white flex justify-between items-center shrink-0 shadow-lg relative z-20">
          ...
          <div className="flex-1 overflow-y-auto custom-scrollbar w-full">
            <div className="w-full min-h-full flex flex-col gap-10 bg-white p-12 shadow-sm border-t border-slate-100">
              <div className="flex items-end justify-between gap-6">
                ...
                <div className="flex items-center gap-4 text-slate-400 text-sm bg-slate-50 px-6 py-3 rounded-2xl border border-slate-100">
              ...
              <div className="space-y-4">
                <div className="flex justify-center scale-100 h-40 items-center bg-[#0a0a0a] rounded-[1rem] border-4 border-[#1d2d6a]/20 overflow-hidden shadow-inner w-full">
              ...
              <div className="grid grid-cols-2 gap-12 pt-8 border-t border-slate-100">
                <div className="flex flex-col gap-6">
                  <div>
                    <h4 className="text-2xl font-bold text-[#1d2d6a] tracking-tight">
                      Display Type
                    </h4>
                  ...
                  <div className="flex flex-col gap-4">
                    <button
                      ...
                      className={`w-full py-8 px-6 rounded-3xl font-bold text-2xl transition-all border-2 flex items-center justify-between ${ledType === "indoor" ? "border-[#ee6f1f] bg-[#ee6f1f]/5 text-[#ee6f1f] shadow-md" : "border-slate-100 bg-slate-50 text-slate-400 hover:border-slate-200"}`}
                    >
                      P2.5 Indoor Cabinet
                      <div
                        className={`w-6 h-6 rounded-full border-4 ${ledType === "indoor" ? "border-[#ee6f1f] bg-white" : "border-slate-200"}`}
                      />
                    </button>
                    <button
                      onClick={() => onSetLedType("p10_32_16")}
                      className={`w-full py-8 px-6 rounded-3xl font-bold text-2xl transition-all border-2 flex items-center justify-between ${ledType === "p10_32_16" ? "border-[#ee6f1f] bg-[#ee6f1f]/5 text-[#ee6f1f] shadow-md" : "border-slate-100 bg-slate-50 text-slate-400 hover:border-slate-200"}`}
                    >
                      P10 Outdoor Module
                      <div
                        className={`w-6 h-6 rounded-full border-4 ${ledType === "p10_32_16" ? "border-[#ee6f1f] bg-white" : "border-slate-200"}`}
                      />
                    </button>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-6">
                  <div className="flex justify-between items-start">
                    ...
                    <div className="text-3xl font-bold text-[#ee6f1f] bg-orange-50 px-6 py-3 rounded-2xl border border-orange-100 font-mono shadow-sm">
                      {masterSyncedLedSpeed}
                  ...
                  <div className="flex-1 flex flex-col justify-center bg-slate-50 rounded-[2.5rem] p-8 border border-slate-100">
                    <div className="relative py-4">
                      <input
                        ...
                        className="w-full h-6 bg-slate-200 rounded-3xl appearance-none cursor-pointer accent-[#ee6f1f]"
                      />
                      <div className="flex justify-between text-xs font-bold text-slate-400 mt-6 tracking-widest uppercase">
                        <span className="flex flex-col items-start">
                          <span>Fast</span>
                          <span className="h-2 w-px bg-slate-200 mt-2 ml-2" />
                        </span>
                        <span className="flex flex-col items-center">
                          <span>Standard</span>
                          <span className="h-2 w-px bg-slate-200 mt-2" />
                        </span>
                        <span className="flex flex-col items-end">
                          <span>Slow</span>
                          <span className="h-2 w-px bg-slate-200 mt-2 mr-2" />
                        </span>
                      </div>
                    </div>
                  </div>
