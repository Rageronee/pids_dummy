      ...
      >
        <div className="flex items-center gap-4">
          ...
          <div className="flex flex-col">
            <span className="text-sm lg:text-base font-bold text-[#1d2d6a]">
              {title}
            </span>
            {!isOpen && summary && (
              <div className="text-xs font-bold text-slate-400 mt-1 hidden sm:block">
                {summary}
              </div>
            )}
          </div>
        ...
        <div
          className={`p-2 rounded-full transition-transform duration-300 ${isOpen ? "bg-slate-100 rotate-180" : "bg-transparent rotate-0"}`}
        >
