...
export function StateToggle({ value, label1 = "auto", label2 = "custom", onChange }: { value: string, label1?: string, label2?: string, onChange?: (val: string) => void }) {
    ...
    return (
        <button
            ...
            className={`px-3 py-1 text-[8px] font-bold rounded-lg transition-all border shadow-sm ${isFirst
