    ...
    <>
      ...
      <AnimatePresence>
        {toast && (
          ...
          >
            <div
              className={`absolute left-0 top-0 bottom-0 w-2 ${toast.ok ? "bg-[#1d2d6a]" : "bg-red-600"}`}
            />
            <div className="relative p-5 pl-7 pb-6">
              ...
              <div className="flex gap-4">
                ...
                <div className="flex flex-col pr-6">
                  <span
                    className={`font-semibold text-lg leading-tight mb-2 ${toast.ok ? "text-[#1d2d6a]" : "text-red-700"}`}
                  >
            ...
            <div
              className={`h-1.5 w-full ${toast.ok ? "bg-orange-100" : "bg-red-100"} absolute bottom-0 left-0`}
            >
              <motion.div
                initial={{ width: "100%" }}
                animate={{ width: "0%" }}
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-[#0b1437]/60 backdrop-blur-sm">
            ...
            >
              <div className="bg-blue-50 p-6 flex flex-col items-center justify-center border-b border-blue-100">
                ...
                <h3 className="text-xl font-bold text-[#1d2d6a] text-center">
                  Tampilkan Video?
                </h3>
              </div>
              ...
              <div className="p-6 pt-0 flex gap-3">
                <button
                  ...
                  className="flex-1 py-3 px-4 bg-slate-100 hover:bg-slate-200 text-slate-600 font-bold text-xs rounded-xl transition-all shadow-sm"
                >
                  Batal
                </button>
                <button
                  ...
                  className="flex-1 py-3 px-4 bg-[#1d2d6a] hover:bg-[#152355] text-white font-bold text-xs rounded-xl transition-all shadow-[0_4px_12px_rgba(29,45,106,0.3)]"
                >
                  Ya, Tampilkan
                </button>
              </div>
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-[#0b1437]/60 backdrop-blur-sm">
            ...
            >
              ...
              <div className="p-6 text-center text-slate-500 text-sm font-bold leading-relaxed">
                ...
                <span className="text-[#1d2d6a] font-bold">{routeName}</span>?
            ...
            >
              <div className="bg-slate-50 p-6 flex flex-col items-center justify-center border-b border-slate-200 relative">
                <button
                  ...
                  className="absolute top-4 right-4 text-slate-400 hover:text-slate-600 bg-transparent border-none p-1 rounded-full"
                >
                  <X size={18} strokeWidth={2.5} />
                </button>
                <h3 className="text-xl font-bold text-[#1d2d6a] text-center">
              ...
              <div className="p-6 space-y-4">
                <label className="flex items-center gap-3 text-sm font-bold text-slate-600 cursor-pointer hover:text-[#1d2d6a] transition-colors bg-slate-50 p-3 rounded-xl border border-slate-100">
                  <input
                    ...
                    className="w-5 h-5 rounded text-[#1d2d6a] focus:ring-[#1d2d6a] border-slate-300"
                  />
                ...
                <div className="flex items-center justify-between gap-3 bg-slate-50 p-3 rounded-xl border border-slate-100">
                  ...
                  <select
                    ...
                    className="text-sm font-bold text-slate-700 bg-white border border-slate-200 rounded-lg py-1.5 px-3 focus:outline-none focus:border-[#ee6f1f] cursor-pointer outline-none"
                  >
              ...
              <div className="p-6 pt-0 border-t border-slate-100 mt-4 flex justify-end">
                <button
                  onClick={() => setShowAudioSettings(false)}
                  className="py-2.5 px-6 bg-[#1d2d6a] hover:bg-[#152355] text-white font-bold text-xs rounded-xl transition-all shadow-sm"
                >
                  Tutup
                </button>
              </div>
