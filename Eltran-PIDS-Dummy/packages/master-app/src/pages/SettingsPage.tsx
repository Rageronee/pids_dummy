...
import { Sun, Moon, Monitor, Shield, Info, Volume2, Video } from "lucide-react";
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-10 py-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Theme Settings */}
        <section className="bg-white dark:bg-slate-900 rounded-[2.5rem] p-10 shadow-sm border border-slate-100 dark:border-slate-800 space-y-8 transition-all hover:shadow-md">
        ...
        {/* System Info */}
        <section className="bg-white dark:bg-slate-900 rounded-[2.5rem] p-10 shadow-sm border border-slate-100 dark:border-slate-800 space-y-8 md:col-span-2">
          <div className="flex items-center gap-4 border-b border-slate-50 dark:border-slate-800 pb-6">
