  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-end justify-between">
        <div>
          <h2 className="text-2xl font-bold text-[#1d2d6a] tracking-tight mb-1">
            Manajemen Pengguna
          </h2>
        ...
        <button
          ...
          className={`flex items-center gap-2 h-10 px-6 rounded-2xl font-semibold text-sm transition-all active:scale-95 ${showForm ? "bg-slate-100 text-slate-500 hover:bg-slate-200 border border-slate-200" : "bg-[#ee6f1f] text-white hover:bg-[#d45d15] shadow-md"}`}
        >
          {showForm ? (
            <>
              <X size={16} />
        ...
        {loading ? (
          ...
          users.map((u, i) => (
            ...
            >
              ...
              <span className="text-[#1d2d6a] font-semibold">
                {u.full_name}
              </span>
              ...
              <span
                className={`inline-flex items-center gap-2 px-3 py-1 rounded-xl text-[11px] font-semibold w-fit ${u.role === "Admin" ? "bg-[#ee6f1f]/10 text-[#ee6f1f]" : "bg-blue-500/10 text-blue-500"}`}
              >
                <Shield size={12} />
                {u.role}
              </span>
