...
export default function StationsPage({
  ...
  useEffect(() => {
    ...
    const lat = Number(selectedStation.latitude) || -6.17677;
    ...
    try {
      ...
      el.className =
        "w-6 h-6 bg-[#ee6f1f] rounded-full border-4 border-white shadow-[0_0_20px_rgba(238,111,31,0.6)] animate-pulse relative z-50";
        ...
        if (data.success) {
          ...
          const enhancedStations = data.stations.map((s: any) => {
            ...
            return {
              ...
              displays_active:
                s.displays_active ?? Math.floor(Math.random() * 40) + 10,
              next_sync:
                s.next_sync ??
                (Math.random() > 0.5
  ...
  useEffect(() => {
    ...
    socket.on("db:update", () => {
      console.log(
        "[Socket.IO] Database update received, re-fetching stations...",
      );
    ...
    setHeaderTitle(
      <div className="flex items-center gap-3 text-xl font-black uppercase">
        {selectedStation ? (
          ...
          <span className="text-[#1d2d6a] tracking-normal uppercase">
            Manajemen Stasiun
          </span>
        )}
      </div>,
        ...
        {selectedStation ? (
              ...
              <img
                src={
                  selectedStation.media
                    ? `${API}/media/station/${selectedStation.media}`
                    : `${API}/media/station/station_fallback.png`
                }
                alt={selectedStation.name}
                className="w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105"
                onError={(e: any) => {
                  e.target.src = `${API}/media/station/station_fallback.png`;
                }}
              />
                ...
                >
                  <div className="bg-white border border-slate-200 rounded-[2.5rem] shadow-xl shadow-slate-200/40 overflow-hidden">
                    <div className="p-6 border-b bg-slate-50/50 flex items-center gap-3">
                      ...
                      <div>
                        <h3 className="text-lg font-black text-[#1d2d6a] tracking-tight">
                          Informasi Dasar
                        </h3>
                        <p className="text-xs font-medium text-slate-400">
                          Station identity & contact person
                        </p>
                      </div>
                    </div>
                    <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          placeholder="e.g. Gambir Station"
                          className="w-full border-2 border-slate-100 rounded-2xl px-5 py-3.5 text-sm font-bold text-[#1d2d6a] focus:border-[#ee6f1f] focus:ring-4 focus:ring-[#ee6f1f]/5 outline-none transition-all placeholder:text-slate-300"
                        />
                      </div>
                      <div className="space-y-2">
                        <label className="text-xs font-black text-slate-500 uppercase tracking-widest">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setForm({
                              ...form,
                              kode_kota: e.target.value.toUpperCase(),
                            })
                          }
                          placeholder="E.G. GMR"
                          className="w-full border-2 border-slate-100 rounded-2xl px-5 py-3.5 text-sm font-bold text-[#1d2d6a] focus:border-[#ee6f1f] focus:ring-4 focus:ring-[#ee6f1f]/5 outline-none transition-all placeholder:text-slate-300 uppercase"
                        />
                      </div>
                      <div className="space-y-2">
                        <label className="text-xs font-black text-slate-500 uppercase tracking-widest">
                      ...
                      <div className="space-y-2">
                        ...
                        <input
                          value={form.fixed_line || ""}
                          onChange={(e) =>
                            setForm({ ...form, fixed_line: e.target.value })
                          }
                          placeholder="(021) 3862222"
                          className="w-full border-2 border-slate-100 rounded-2xl px-5 py-3.5 text-sm font-bold text-[#1d2d6a] focus:border-[#ee6f1f] focus:ring-4 focus:ring-[#ee6f1f]/5 outline-none transition-all placeholder:text-slate-300"
                        />
                      </div>
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          className="w-full border-2 border-slate-100 rounded-2xl px-5 py-3.5 text-sm font-bold font-mono text-[#1d2d6a] focus:border-[#ee6f1f] focus:ring-4 focus:ring-[#ee6f1f]/5 outline-none transition-all placeholder:text-slate-300"
                        />
                      </div>
                    </div>
                    ...
                    <div className="p-8 space-y-8">
                        ...
                        <div className="lg:col-span-4 flex flex-col justify-center gap-6">
                          <div className="space-y-2">
                            ...
                            <input
                              ...
                              className="w-full border-2 border-slate-100 rounded-2xl px-5 py-3.5 text-sm font-mono font-bold text-[#1d2d6a] focus:border-[#ee6f1f] outline-none transition-all"
                            />
                          </div>
                          <div className="space-y-2">
                            <label className="text-xs font-black text-slate-500 uppercase tracking-widest">
                          ...
                          <div className="p-5 bg-blue-50 rounded-2xl flex gap-4 border border-blue-100">
                            ...
                            <p className="text-[12px] text-[#1d2d6a] leading-relaxed font-bold">
                              Coordinates are used for the PIDS real-time map
                      ...
                      <div className="space-y-2 pt-4 border-t border-slate-100">
                        ...
                        <textarea
                          ...
                          placeholder="Street name, building number, district, etc."
                          rows={2}
                          className="w-full border-2 border-slate-100 rounded-2xl px-5 py-3.5 text-sm font-bold text-[#1d2d6a] focus:border-[#ee6f1f] outline-none transition-all resize-none"
                        />
                      </div>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div className="space-y-2">
                          ...
                          <select
                            ...
                            className="w-full border-2 border-slate-100 rounded-2xl px-5 py-3.5 text-sm font-bold text-[#1d2d6a] focus:border-[#ee6f1f] outline-none appearance-none bg-white cursor-pointer"
                          >
                        ...
                        <div className="space-y-2">
                          ...
                          <input
                            ...
                            className="w-full border-2 border-slate-100 rounded-2xl px-5 py-3.5 text-sm font-bold text-[#1d2d6a] focus:border-[#ee6f1f] outline-none transition-all"
                          />
                        </div>
                      </div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    <div className="space-y-6">
                      <div className="flex items-center gap-3 px-2">
                        ...
                        <h3 className="text-xs font-black text-[#1d2d6a] uppercase tracking-[0.3em]">
                          Administrative
                        </h3>
                      </div>
                          ...
                          <div className="space-y-6">
                            <div className="space-y-1">
                              ...
                              <p className="text-lg font-bold text-slate-600">
                                {selectedStation.provinsi || "DKI Jakarta"}
                              </p>
                            </div>
                            <div className="space-y-1">
                              <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">
                            ...
                            <div className="space-y-1">
                              ...
                              <p className="text-lg font-bold text-slate-600">
                                {selectedStation.kecamatan || "Gambir"}
                              </p>
                            </div>
                            <div className="space-y-1">
                              <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">
                              ...
                              <p className="text-lg font-bold text-slate-600">
                                {selectedStation.kelurahan || "Gambir"}
                              </p>
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="bg-white rounded-[2.5rem] p-8 border border-slate-100 shadow-xl shadow-slate-200/40 space-y-8 h-full">
                        <div className="bg-blue-50/50 rounded-3xl p-6 border border-blue-100 flex items-center gap-5">
                          ...
                          <div>
                            ...
                            <p className="text-xl font-black text-[#1d2d6a] tracking-tight">
                              {selectedStation.pic_name || "Arya Wiguna"}
                            </p>
                          </div>
                        </div>
                        ...
                        <div className="space-y-6 px-2">
                          ...
                          <div className="flex gap-5">
                            ...
                            <div>
                              ...
                              <p className="text-lg font-black text-[#1d2d6a] break-all">
                                {selectedStation.email ||
                                  `${selectedStation.name.toLowerCase().replace(/\s+/g, ".")}@kai.id`}
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="flex gap-5">
                            ...
                            <div>
                              ...
                              <p className="text-lg font-black text-[#1d2d6a]">
                                {selectedStation.fixed_line || "(021) 3862222"}
                              </p>
                            </div>
                          </div>
                        </div>
                          ...
                          <div className="space-y-1">
                            ...
                            <p className="text-sm font-bold text-slate-600 leading-relaxed italic">
                              {selectedStation.address ||
                                `Jl. Medan Merdeka Timur No.1, RT.5/RW.2, ${selectedStation.city}, Kecamatan Gambir, Kota Jakarta Pusat, Daerah Khusus Ibukota Jakarta`}
                            </p>
                          </div>
                        </div>
                      </div>
                  ...
                  <div className="space-y-6 pt-12">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 pb-20">
                      {[
                        ...
                        <div
                          key={i}
                          className="group bg-white rounded-3xl p-6 border border-slate-100 shadow-lg shadow-slate-200/40 hover:border-[#ee6f1f]/30 transition-all cursor-pointer flex items-center gap-4"
                        >
                          <div
                            className={`w-14 h-14 rounded-2xl flex items-center justify-center transition-transform group-hover:scale-110 ${file.color}`}
                          >
                            {file.icon}
                          </div>
                          <div className="overflow-hidden">
                            <p className="font-black text-[#1d2d6a] truncate">
                              {file.name}
                            </p>
                            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">
                              {file.type}
          ...
          >
            <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
              <div>
                <h1 className="text-3xl font-bold text-[#1d2d6a] tracking-tight mb-1">
                  Station Overview
                </h1>
                <p className="text-slate-500 text-sm font-medium">
                  Manage {total} integrated stations across all divisions
                </p>
              </div>
            </div>
            ...
            <div className="flex overflow-x-auto custom-scrollbar pb-2 -mb-2 gap-3 scroll-smooth no-scrollbar">
              {filterOptions.map((opt) => (
                <button
                  ...
                  className={`px-6 py-3 rounded-full font-semibold text-sm transition-all border-2 shrink-0 ${
                    activeFilter === opt
            ...
            <div className="flex flex-col lg:flex-row gap-6 items-center justify-between">
              ...
              <button
                ...
                className={`flex items-center gap-2 h-11 px-6 rounded-2xl font-semibold text-sm transition-all active:scale-95 shrink-0 ${
                  showForm
                    ...
                    <div className="space-y-8">
                      <div className="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
                        <div className="p-4 border-b bg-slate-50/50 flex items-center gap-3">
                          ...
                          <h3 className="text-lg font-semibold text-[#1d2d6a] tracking-tight">
                            1. Basic Information
                          </h3>
                        </div>
                        <div className="p-8 grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
                          <div className="space-y-2">
                            ...
                            <input
                              ...
                              placeholder="e.g. Gambir Station"
                              className="w-full border border-slate-200 rounded-lg px-4 py-3 text-sm focus:border-blue-500 focus:ring-4 focus:ring-blue-500/5 outline-none transition-all placeholder:text-slate-300"
                            />
                          </div>
                          <div className="space-y-2">
                            <label className="text-sm font-semibold text-slate-700 ml-0.5">
                        ...
                        <div className="p-8 space-y-8">
                            ...
                            <div className="lg:col-span-4 flex flex-col justify-center gap-6">
                              <div className="space-y-2">
                                ...
                                <div className="relative">
                                  <input
                                    ...
                                    className="w-full border border-slate-200 rounded-lg px-4 py-3.5 text-sm font-mono focus:border-blue-500 outline-none transition-all"
                                  />
                                </div>
                              </div>
                              <div className="space-y-2">
                              ...
                              <div className="p-5 bg-blue-50 rounded-xl flex gap-4 border border-blue-100">
                                ...
                                <p className="text-[12px] text-blue-800 leading-relaxed font-semibold">
                                  Coordinates are used for the PIDS real-time
                                  map synchronization across the network. Ensure
                                  markers are precise.
                                </p>
                              </div>
                            </div>
                          ...
                          <div className="space-y-2 pt-4 border-t border-slate-100">
                            ...
                            <textarea
                              ...
                              placeholder="Street name, building number, district, etc."
                              rows={2}
                              className="w-full border border-slate-200 rounded-lg px-4 py-3 text-sm focus:border-blue-500 outline-none transition-all resize-none"
                            />
                          </div>
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="space-y-2">
                              ...
                              <div className="relative">
                                <select
                                  ...
                                  className="w-full border border-slate-200 rounded-lg px-4 py-3 text-sm focus:border-blue-500 outline-none appearance-none bg-slate-50/50 cursor-pointer"
                                >
                                  <option value="">Select Province</option>
                            ...
                            <div className="space-y-2">
                              ...
                              <input
                                ...
                                placeholder="Kecamatan"
                                className="w-full border border-slate-200 rounded-lg px-4 py-3 text-sm focus:border-blue-500 outline-none bg-slate-50/50"
                              />
                            </div>
                          </div>
                          ...
                          <div className="border-2 border-dashed border-slate-200 rounded-2xl p-12 flex flex-col items-center justify-center text-center space-y-4 hover:border-blue-400 hover:bg-blue-50/30 transition-all cursor-pointer bg-slate-50/30 group">
                            ...
                            <div>
                              ...
                              <p className="text-xs text-slate-400 mt-1 max-w-xs mx-auto">
                                Drag and drop station photos, blueprints, or
                                legal documents. Max 10MB per file.
                              </p>
                            </div>
                            <button className="bg-[#1d2d6a] px-8 py-2.5 rounded-lg text-xs font-bold text-white hover:bg-blue-900 transition-all shadow-lg shadow-blue-900/10">
                              Browse Files
                            </button>
                          </div>
                          ...
                          <div className="flex flex-wrap gap-6">
                            {form.media && (
                              <div className="relative group w-52 h-52">
                                <img
                                  src={form.media}
                                  className="w-full h-full object-cover rounded-xl border border-slate-200 shadow-md group-hover:shadow-lg transition-shadow"
                                  alt="Preview"
                                />
                                <button
                                  onClick={() =>
                                  ...
                                  className="absolute -top-3 -right-3 bg-red-500 text-white p-2 rounded-full opacity-0 group-hover:opacity-100 shadow-xl transition-all hover:scale-110 active:scale-90"
                                >
                                  <X size={14} />
                                </button>
                              </div>
                      ...
                      <div className="pt-8 flex items-center justify-end gap-4 border-t border-slate-100">
                        <button
                          ...
                          className="h-12 px-8 rounded-2xl font-semibold text-sm bg-slate-100 text-slate-500 hover:bg-slate-200 transition-all active:scale-95"
                        >
                          Cancel & Discard
                        </button>
                        <button
            ...
            <AnimatePresence mode="wait">
              {loading && stations.length === 0 ? (
                ...
                >
                  ...
                  />
                  <h3 className="text-xl font-semibold text-[#1d2d6a]">
                    No stations found
                  </h3>
                    ...
                    >
                      <div className="relative h-60 overflow-hidden shrink-0">
                        <img
                          src={
                            station.media
                              ? `${API}/media/station/${station.media}`
                              : `${API}/media/station/station_fallback.png`
                          }
                          alt={station.name}
                        ...
                        <div className="absolute top-6 left-6 flex items-center gap-2 px-4 py-2 bg-black/30 backdrop-blur-xl rounded-full border border-white/20">
                          <div
                            className={`w-2.5 h-2.5 rounded-full animate-pulse ${station.status === "ONLINE" ? "bg-green-400" : "bg-orange-400"}`}
                          />
                        ...
                        <div className="absolute top-6 right-6 px-3 py-1 bg-white/90 backdrop-blur-md rounded-lg border border-slate-200 shadow-sm">
                          <span className="font-mono text-[10px] font-black text-[#1d2d6a] tracking-tighter uppercase">
                            {station.id}
                          </span>
                        </div>
                      </div>
                          ...
                          <div className="flex items-center gap-3 text-slate-500">
                            ...
                            <div>
                              ...
                              <p className="text-sm font-bold text-slate-600">
                                {station.city}, {station.provinsi || "Jawa"}
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-center gap-3 text-slate-500">
                            ...
                            <div>
                              ...
                              <p className="text-sm font-bold font-mono text-slate-600">
                                {station.ip_address || "192.168.1.1"}
                              </p>
                            </div>
                          </div>
                        </div>
                ...
                >
                  <table className="w-full text-left">
                    <thead className="bg-[#1d2d6a] text-white">
                      <tr>
                        <th className="px-8 py-6 font-semibold text-[10px] uppercase tracking-wider">
                          Station Name
                        </th>
                        <th className="px-8 py-6 font-semibold text-[10px] uppercase tracking-wider">
                          ID / Code
                        ...
                        <th className="px-8 py-6 font-semibold text-[10px] uppercase tracking-wider text-right">
                          Actions
                        </th>
                      </tr>
                    </thead>
                        ...
                        >
                          <td className="px-8 py-6">
                            <div className="flex items-center gap-4">
                              ...
                              <div>
                                <div className="font-semibold text-[#1d2d6a]">
                                  {station.name}
                                </div>
                          ...
                          <td className="px-8 py-6">
                            <div className="flex items-center gap-2">
                              <div
                                className={`w-2 h-2 rounded-full ${station.status === "ONLINE" ? "bg-green-500" : "bg-orange-500"}`}
                              />
                              <span
                                className={`text-xs font-semibold ${station.status === "ONLINE" ? "text-green-600" : "text-orange-600"}`}
                              >
                                {station.status}
                              </span>
                            </div>
                          ...
                          <td className="px-8 py-6 text-right">
                            <div className="flex justify-end gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                              <button
                                ...
                                className="p-2 text-slate-400 hover:text-[#1d2d6a] hover:bg-slate-100 rounded-xl transition-all"
                              >
                                <Pencil size={18} />
                              </button>
                              <button
        ...
        {deleteTarget && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-6">
            ...
            <motion.div
              ...
              className="relative bg-white rounded-[2.5rem] p-10 max-w-md w-full text-center shadow-2xl"
            >
              <div className="w-20 h-20 bg-red-50 rounded-3xl flex items-center justify-center text-red-500 mx-auto mb-6">
                <Trash2 size={40} />
              </div>
              <h3 className="text-2xl font-semibold text-[#1d2d6a] mb-2">
                Delete Station?
              </h3>
              <p className="text-slate-500 font-bold mb-8">
                Are you sure you want to delete{" "}
                <span className="text-[#ee6f1f]">{deleteTarget.name}</span>?
                This action cannot be undone.
              </p>
              <div className="grid grid-cols-2 gap-4">
                <button
                  onClick={() => setDeleteTarget(null)}
                  className="px-6 py-4 bg-slate-100 text-slate-500 font-semibold rounded-2xl hover:bg-slate-200 transition-all"
                >
                  Cancel
                </button>
                <button
                  onClick={handleDelete}
                  className="px-6 py-4 bg-red-500 text-white font-semibold rounded-2xl shadow-lg shadow-red-500/20 hover:bg-red-600 transition-all"
                >
                  Delete Now
                </button>
              </div>
