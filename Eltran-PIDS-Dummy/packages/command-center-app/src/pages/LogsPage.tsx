    ...
    <div className="space-y-8">
      <div className="flex items-end justify-between">
        ...
        <button
          ...
          className="p-2.5 bg-white rounded-xl border border-slate-200 shadow-sm text-slate-400 hover:text-[#1d2d6a] hover:border-[#1d2d6a] transition-all active:scale-95"
        >
          <RefreshCcw size={16} />
        </button>
      </div>
          ...
          {logs.map((log, i) => {
            ...
            return (
              ...
              >
                ...
                <span className="text-[#1d2d6a] text-sm font-semibold self-center">
                  {log.user}
                </span>
                <span className="text-slate-400 text-xs font-medium self-center">
                  {log.role}
                </span>
                <span className="text-slate-600 text-sm font-medium self-center pr-6">
                  {log.details}
                </span>
              </motion.div>
            );
