/** /shared/src/components/ErrorBoundary.tsx — untuk mengubah: penanganan error tampilan; fungsi utama: ErrorBoundary */
...
> {
  ...
  public componentDidCatch(error: Error, errorInfo: ErrorInfo) {
    console.error(
      `${this.props.systemName || "System"} Crash:`,
      error,
      errorInfo,
    );
  }
      ...
      if (this.props.mode === "display") {
        return (
          <div className="flex flex-col h-screen w-full bg-[#1d2d6a] text-white font-sans items-center justify-center p-10 text-center">
            <AlertTriangle
              size={120}
              className="text-[#ee6f1f] mb-8 animate-pulse"
            />
            ...
            <p className="text-2xl font-bold text-blue-200/80 max-w-2xl leading-relaxed mb-12">
              PIDS System is currently undergoing routine maintenance or
              recovering from an unexpected state. Please stand by.
            </p>
